...
This PR transforms DialHook from an SMS text-back system into a voice AI receptionist. Instead of texting callers after a missed call, DialHook now answers the call with AI, qualifies the lead through natural conversation, and books the appointment — all before the caller hangs up.
